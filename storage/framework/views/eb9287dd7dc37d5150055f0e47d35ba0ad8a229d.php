    ...
    <div class="col-sm-12 col-md-8 col-lg-9">
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td>
            <a href="<?php echo e(route('weather.show', $one->state->id)); ?>" class="btn btn-sm btn-primary">More</a>
          </td>
        </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nstack/Documents/Projects/final_year_projeccts/farmer/resources/views/user/weather/index.blade.php ENDPATH**/ ?>