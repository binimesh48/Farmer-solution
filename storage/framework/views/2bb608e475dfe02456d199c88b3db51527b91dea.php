...
<div class="container my-4">
  ...
  <table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td>
        <a href="<?php echo e(route('admin.area.create','district')); ?>?id=<?php echo e($one->id); ?>" class="btn btn-secondary btn-sm">Add
          District</a>
      </td>
    </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nstack/Documents/Projects/final_year_projeccts/farmer/resources/views/admin/area/home.blade.php ENDPATH**/ ?>